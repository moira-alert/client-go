...
// MoiraCheckData moira check data
//
// swagger:model moira.CheckData
...
// Validate validates this moira check data
...
// ContextValidate validate this moira check data based on the context it is used
func (m *MoiraCheckData) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *MoiraCheckData) contextValidateMaintenanceInfo(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MoiraCheckData) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *MoiraCheckData) UnmarshalBinary(b []byte) error {
	var res MoiraCheckData
