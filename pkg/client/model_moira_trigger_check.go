...
// checks if the MoiraTriggerCheck type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MoiraTriggerCheck{}

// MoiraTriggerCheck struct for MoiraTriggerCheck
...
func (o *MoiraTriggerCheck) SetCreatedAtNil() {
	o.CreatedAt.Set(nil)
}
...
func (o *MoiraTriggerCheck) SetDescNil() {
	o.Desc.Set(nil)
}
...
func (o *MoiraTriggerCheck) SetErrorValueNil() {
...
func (o *MoiraTriggerCheck) SetExpressionNil() {
...
func (o *MoiraTriggerCheck) SetPythonExpressionNil() {
...
func (o *MoiraTriggerCheck) SetSchedNil() {
	o.Sched.Set(nil)
}
...
func (o *MoiraTriggerCheck) SetTtlStateNil() {
	o.TtlState.Set(nil)
}
...
func (o *MoiraTriggerCheck) SetUpdatedAtNil() {
	o.UpdatedAt.Set(nil)
}
...
func (o *MoiraTriggerCheck) SetWarnValueNil() {
	o.WarnValue.Set(nil)
}
...
func (o MoiraTriggerCheck) MarshalJSON() ([]byte, error) {
...
func (o MoiraTriggerCheck) ToMap() (map[string]interface{}, error) {
...
type NullableMoiraTriggerCheck struct {
	value *MoiraTriggerCheck
	isSet bool
}

func (v NullableMoiraTriggerCheck) Get() *MoiraTriggerCheck {
	return v.value
}

func (v *NullableMoiraTriggerCheck) Set(val *MoiraTriggerCheck) {
	v.value = val
	v.isSet = true
}

func (v NullableMoiraTriggerCheck) IsSet() bool {
	return v.isSet
}

func (v *NullableMoiraTriggerCheck) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMoiraTriggerCheck(val *MoiraTriggerCheck) *NullableMoiraTriggerCheck {
	return &NullableMoiraTriggerCheck{value: val, isSet: true}
}

func (v NullableMoiraTriggerCheck) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMoiraTriggerCheck) UnmarshalJSON(src []byte) error {
	v.isSet = true
