...
// checks if the MoiraSubscriptionData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MoiraSubscriptionData{}

// MoiraSubscriptionData struct for MoiraSubscriptionData
...
func (o *MoiraSubscriptionData) SetSchedNil() {
	o.Sched.Set(nil)
}
...
func (o MoiraSubscriptionData) MarshalJSON() ([]byte, error) {
...
func (o MoiraSubscriptionData) ToMap() (map[string]interface{}, error) {
...
type NullableMoiraSubscriptionData struct {
	value *MoiraSubscriptionData
	isSet bool
}

func (v NullableMoiraSubscriptionData) Get() *MoiraSubscriptionData {
	return v.value
}

func (v *NullableMoiraSubscriptionData) Set(val *MoiraSubscriptionData) {
	v.value = val
	v.isSet = true
}

func (v NullableMoiraSubscriptionData) IsSet() bool {
	return v.isSet
}

func (v *NullableMoiraSubscriptionData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMoiraSubscriptionData(val *MoiraSubscriptionData) *NullableMoiraSubscriptionData {
	return &NullableMoiraSubscriptionData{value: val, isSet: true}
}

func (v NullableMoiraSubscriptionData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMoiraSubscriptionData) UnmarshalJSON(src []byte) error {
	v.isSet = true
