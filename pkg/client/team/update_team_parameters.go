...
func (o *UpdateTeamParams) WithTeam(team *models.DtoTeamModel) *UpdateTeamParams {
	o.SetTeam(team)
	return o
}

// SetTeam adds the team to the update team params
func (o *UpdateTeamParams) SetTeam(team *models.DtoTeamModel) {
	o.Team = team
}
