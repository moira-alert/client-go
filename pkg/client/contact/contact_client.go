...
// New creates a new contact API client with basic auth credentials.
...
// New creates a new contact API client with a bearer token for authentication.
// It takes the following parameters:
// - host: http host (github.com).
// - basePath: any base path for the API client ("/v1", "/v3").
// - scheme: http scheme ("http", "https").
...
type ClientService interface {
	...
	GetContactsNoisiness(params *GetContactsNoisinessParams, opts ...ClientOption) (*GetContactsNoisinessOK, error)
...
func (a *Client) GetContactsNoisiness(params *GetContactsNoisinessParams, opts ...ClientOption) (*GetContactsNoisinessOK, error) {
	...
	op := &runtime.ClientOperation{
		...
		Method:             "GET",
		PathPattern:        "/contact/noisiness",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &GetContactsNoisinessReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	for _, opt := range opts {
